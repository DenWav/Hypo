...
[![Maven Central Version 1.2.0](https://img.shields.io/badge/Maven_Central-1.2.0-blue?logo=apache-maven&style=flat)](https://search.maven.org/search?q=g:dev.denwav.hypo)
...
> 
> dependencies {
>     implementation(platform("dev.denwav.hypo:hypo-platform:1.2.0"))
