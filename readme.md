...
[![Maven Central Version 3.1.0](https://img.shields.io/badge/Maven_Central-3.1.0-blue?logo=apache-maven&style=flat)](https://search.maven.org/search?q=g:dev.denwav.hypo)
...
> 
> dependencies {
>     implementation(platform("dev.denwav.hypo:hypo-platform:3.1.0"))
